...
- [x] Copy pass: pillars, claims audit, tagline, beat table
- [x] Design system: tokens, type, Caption, Memphis kit, font-cycle wordmark
- [x] Styleframes 16:9 ×14, 9:16 ×10, 4:5 ×10 + contact sheets (`out/design/`)
- [x] 3D mocks ×6 + contact sheet (`out/mocks/`)
- [x] Add-on probe (above)
...
- [ ] Licensed GLB swapped in
- [ ] `npm run render` with `--scale 2`; 9:16 and 4:5 renders
- [ ] SFX track (copy of the set); sound-designer package
